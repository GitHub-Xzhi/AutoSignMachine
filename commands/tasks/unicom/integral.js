      ...
      axios
        .request({
          ...
          headers: {
            ...
            referer:
              "https://img.client.10010.com/jifenshangcheng/jifen?loginType=0&scopeType=fl",
        ...
        .then((res) => {
          ...
          if (result.code !== "0") {
            ...
            console.log(
              "总奖励积分%s,可用奖励积分%s",
              result.resdata.score.totalscore,
              result.resdata.score.availablescore
            );
          }
          resolve();
        })
      ...
      axios
        ...
        .then((res) => {
          ...
          if (result.code !== "200") {
            ...
            console.log(
              "总定向积分%s,可用定向积分%s,月到期%s",
              result.resdata.total,
              result.resdata.Surplus,
              result.resdata.expnum
            );
          }
          resolve();
        })
      ...
      axios
        .request({
          ...
          headers: {
            "user-agent": useragent,
            referer:
              "https://act.10010.com/SigninApp/signinCoinDetails/jumpCoinDetails.do",
            origin: "https://act.10010.com",
          },
      ...
      axios
        ...
        .then((res) => {
          ...
          if (result.resdata.code !== "0000") {
            ...
            console.log(
              "获取东奥积分活动状态成功 已连续领取%s天",
              result.resdata.signDays
            );
          }
          resolve();
        })
